...
var Accordion = React10.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React10.useContext(PrimeReactContext);
  var props = AccordionBase.getProps(inProps, context);
  var _React$useState = React10.useState(props.id), _React$useState2 = _slicedToArray(_React$useState, 2), idState = _React$useState2[0], setIdState = _React$useState2[1];
  var _React$useState3 = React10.useState(props.activeIndex), _React$useState4 = _slicedToArray(_React$useState3, 2), activeIndexState = _React$useState4[0], setActiveIndexState = _React$useState4[1];
  var elementRef = React10.useRef(null);
  var activeIndex = props.onTabChange ? props.activeIndex : activeIndexState;
  var count = React10.Children.count(props.children);
  var metaData = {
    props,
    state: {
      id: idState,
  ...
  var _AccordionBase$setMet = AccordionBase.setMetaData(_objectSpread2({}, metaData)), ptm = _AccordionBase$setMet.ptm, ptmo = _AccordionBase$setMet.ptmo, cx = _AccordionBase$setMet.cx;
  ...
  var createTabHeader = function createTabHeader2(tab, selected, index) {
    var style = _objectSpread2(_objectSpread2({}, getTabProp(tab, "style") || {}), getTabProp(tab, "headerStyle") || {});
    ...
    var header2 = getTabProp(tab, "headerTemplate") ? ObjectUtils.getJSXElement(getTabProp(tab, "headerTemplate"), tabCProps) : React10.createElement("span", headerTitleProps, ObjectUtils.getJSXElement(getTabProp(tab, "header"), tabCProps));
    var headerIconProps = mergeProps({
      "aria-hidden": "true",
      className: cx("tab.headericon")
    }, getTabPT(tab, "headericon", index));
    var icon = selected ? props.collapseIcon || React10.createElement(ChevronDownIcon, headerIconProps) : props.expandIcon || React10.createElement(ChevronRightIcon, headerIconProps);
    var toggleIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, headerIconProps), {
      props,
      selected
    });
    ...
    return React10.createElement("div", headerProps, React10.createElement("a", headerActionProps, toggleIcon, header2));
  };
  var createTabContent = function createTabContent2(tab, selected, index) {
    var style = _objectSpread2(_objectSpread2({}, getTabProp(tab, "style") || {}), getTabProp(tab, "contentStyle") || {});
    var contentId = idState + "_content_" + index;
    var ariaLabelledby = idState + "_header_" + index;
    var contentRef = React10.createRef();
    ...
    return React10.createElement(CSSTransition2, _extends4({
      nodeRef: contentRef
    }, transitionProps), React10.createElement("div", toggleableContentProps, React10.createElement("div", contentProps, getTabProp(tab, "children"))));
  };
  var createTab = function createTab2(tab, index) {
    if (ObjectUtils.isValidChild(tab, "AccordionTab")) {
      ...
      return React10.createElement("div", _rootProps, tabHeader, tabContent);
    }
    return null;
  };
  var createTabs = function createTabs2() {
    return React10.Children.map(props.children, createTab);
  };
  var tabs = createTabs();
  ...
  return React10.createElement("div", _extends4({
    id: idState,
    ref: elementRef
  }, rootProps), tabs);
});
